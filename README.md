...
| **site/** | Публичный сайт заказов (каталог, корзина, наличие с API) — статичный HTML/JS |
| **sklad/** | iOS-приложение (Swift/SwiftUI) для сотрудников: склад, добавление поставок/отгрузок, штрихкоды |
...
- [site/README.md](site/README.md) — настройка подключения сайта к API.
